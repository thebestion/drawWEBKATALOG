<br /><br />
<h2>Premium Eintr&auml;ge</h2>
<?
######## DELETE Link ##############
if($subpage=="del") {
include("core/del_new_link.htm");
if($delquest=="YES") { del_prem_link($pageid); echo"<meta http-equiv='refresh' content='0; URL=index.php?s=prem_eintrag&ps=".$pagesite."'>"; }
}
...
dbconnect();
    $sqltag_cat="SELECT COUNT(*) FROM ".get_db_table("prem_link")." ";
